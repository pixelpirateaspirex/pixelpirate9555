...
//  2. Click → POST /api/payments/create-session → Stripe Checkout
//  3. Stripe redirects:
//       /premium/success?session_id=XXX → PaymentSuccess component
//       /premium/cancel                 → PaymentCancel component
//
//  If Stripe is not configured, shows mock confirmation flow.
  ...
  return (
    <div className="pp-crown-wrap">
      {[...Array(3)].map((_, i) => (
        <motion.div
          key={i}
          className="pp-crown-ring"
          animate={{ scale: [1, 2.2], opacity: [0.35, 0] }}
          transition={{ duration: 2.5, repeat: Infinity, delay: i * 0.8, ease: 'easeOut' }}
        />
      ))}
      <motion.div
        className="pp-crown-icon"
...
export function PaymentSuccess() {
  ...
  useEffect(() => {
    ...
    if (sessionId) api.post('/payments/confirm', { sessionId }).catch(() => {});
  ...
  return (
    <div className="pp-page pp-page--center pp-page--in">
      ...
      >
        ...
        <motion.div
          style={{ fontSize: '3.8rem', marginBottom: '1rem', display: 'block' }}
        ...
        >
          No charge was made. You can upgrade any time you're ready.
        </motion.p>
    ...
    <div className="pp-page pp-page--center pp-page--in">
      ...
      >
        ...
        <motion.p
          ...
          transition={{ delay: 0.45 }}
        >
          Enjoy all the exclusive features of Pixel Pirates Premium.
        </motion.p>
...
export default function PremiumPage() {
  ...
  useEffect(() => {
    ...
    api.get('/auth/me').then(({ data }) => {
      if (data.user?.premium) setSubscribed(true);
    }).catch(() => {});
  }, [isLoggedIn]);
  ...
  const handleCheckout = async () => {
    ...
    try {
      ...
      error('Stripe not configured. Showing mock flow.');
      setLoading(false);
    }
  };
    ...
    <div className={`pp-page ${mounted ? 'pp-page--in' : ''}`}>
      ...
      <div className="pp-container">
        ...
        >
          ...
          >
            Upgrade to{' '}
            <span className="pp-title-accent">Premium</span>
          </motion.h1>
          ...
          >
            Unlock the full Pixel Pirates experience
          </motion.p>

          {/* Trust badges */}
          <motion.div
            className="pp-trust-row"
            initial={{ opacity: 0, y: 14 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.45 }}
          >
        ...
        <div className="pp-layout">
          ...
          {/* Plan card */}
          <motion.div
            className="pp-plan-card pp-card"
          ...
          >
            ...
            <motion.button
              ...
              whileHover={!loading ? {
                scale: 1.03, y: -3,
                boxShadow: '0 14px 40px rgba(245,197,66,0.5)',
          ...
          >
            ...
            >
              ...
              <div className="pp-proof-text">
                <strong>10,000+ users</strong> already enjoying Premium
              </div>
            </motion.div>
          </motion.div>
...
const styles = `
  ...
  .pp-rays {
    ...
    background: radial-gradient(ellipse at top, rgba(245,197,66,0.07), transparent 70%);
    pointer-events: none;
  }
  ...
  .pp-badge {
    ...
    background: linear-gradient(120deg, #f5c542, #ffd97a);
    color: #07101f;
    font-size: 0.7rem;
    font-weight: 800;
    ...
    box-shadow: 0 3px 12px rgba(245,197,66,0.35);
  }
  ...
  .pp-pay-btn {
    ...
    background: linear-gradient(135deg, #f5c542 0%, #ffd97a 50%, #e6b030 100%);
    background-size: 200% auto;
  ...
  .pp-avatar {
    ...
    border: 2px solid var(--bg, #07101f);
    font-size: 1rem;
    display: flex; align-items: center; justify-content: center;
    margin-left: -8px;
  }
  ...
  .pp-cta-btn:hover {
    ...
    box-shadow: 0 10px 32px rgba(245,197,66,0.45);
  }
  ...
  @keyframes ppBtnGlow {
    0%, 100% { box-shadow: 0 6px 24px rgba(245,197,66,0.35); }
    50%       { box-shadow: 0 6px 36px rgba(245,197,66,0.55); }
  }
  ...
  @media (max-width: 720px) {
    ...
    .pp-hero { margin-bottom: 2rem; }
  }
  @media (max-width: 480px) {
    .pp-trust-row { gap: 0.4rem; }
    .pp-trust-badge { font-size: 0.68rem; padding: 0.25rem 0.65rem; }
    .pp-card { border-radius: 16px; }
    .pp-pay-btn { font-size: 0.9rem; }
  }
  @media (prefers-reduced-motion: reduce) {
    .pp-orb, .pp-crown-ring, .pp-crown-icon,
    .pp-title-accent, .pp-pay-btn { animation: none !important; }
    .pp-card-glow-border { animation: none !important; }
  }
`;
